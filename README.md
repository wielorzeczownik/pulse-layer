...
<p align="center">
  Heart rate overlay for OBS - reads BPM live from a Bluetooth smart ring and serves a browser widget straight to your stream.
</p>
...
Made for VTuber **[KitsuneTsuyu](https://www.twitch.tv/kitsunetsuyu)** as a cheap way to show live heart rate on stream. Just a €20-30 smart ring, this app, and OBS.

Works really well as a stress HUD too. Playing a horror game and want your viewers to watch your heart rate spike? This does that.
...
Tested on **Smartring COLMI R12**. Older COLMI models and other rings that use the same BLE protocol should work too.
...
Release artifacts:
- `pulse-layer-<version>-aarch64-apple-darwin.tar.gz` — macOS on Apple Silicon (M1/M2/M3/M4)
- `pulse-layer-<version>-x86_64-apple-darwin.tar.gz` — macOS on Intel
- `pulse-layer-<version>-x86_64-pc-windows-msvc.zip` — Windows 64-bit
- `pulse-layer-<version>-x86_64-unknown-linux-gnu.tar.gz` — Linux 64-bit
